import pytest
from scripts.WalletManagement import get_balances, rebalance_wallets, get_total_balance, make_trades, close_trade, make_transfer
...
def test_make_trades():
    ...
    make_trades(last_position, 0, BTC_price, True, 5, 25, 25, 0.25)
